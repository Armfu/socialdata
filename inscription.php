...
if($_POST)
{
	...
	if(empty($contenu)) 
	{
		...
		else
		{
			...
			executeRequete("INSERT INTO membre (pseudo, mdp, nom, prenom, email, civilite, ville, adresse) VALUES ('$_POST[pseudo]', '$_POST[mdp]', '$_POST[nom]', '$_POST[prenom]', '$_POST[email]', '$_POST[civilite]', '$_POST[ville]', '$_POST[adresse]')");
